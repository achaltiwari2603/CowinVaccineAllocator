...
#app.iconbitmap("C:\Users\$.DESKTOP-IJTGNH1\Downloads\covid-vaccine.ico")
...
# Buttons
#search_vaccine_image = PhotoImage(file="https://raw.githubusercontent.com/aipythonIndia/GUI_Vaccine_availability/main/Images_Icons/search-icon.png")
search_vaccine_btn = Button(app, bg=top_right_frame_bg, command=search_vaccine_avl,
                            relief=RAISED)
